...
class TrainOptions:
	...
	def initialize(self):
		...
		self.parser.add_argument('--data_dir', type=str, help='Path to dataset directory')
		...
		self.parser.add_argument('--facenet_path', default=None, type=str, help='Path to facenet irse50 model checkpoint')
