...
from datasets.idn import ImdbDataset
...
class Coach:
		...
		while self.global_step < self.opts.max_steps:
			for batch_idx, batch in enumerate(self.train_dataloader):
				...
				if self.global_step % self.opts.image_interval == 0 or (
					...
					self.parse_and_log_images(id_logs, x, y, y_hat,fcbox, title='images/train/faces')
	...
	def validate(self):
		...
		for batch_idx, batch in enumerate(self.test_dataloader):
			...
			# Logging related
			self.parse_and_log_images(id_logs, x, y, y_hat,fcbox,
